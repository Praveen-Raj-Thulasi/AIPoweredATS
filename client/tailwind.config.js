...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-subtle': '0 10px 25px -5px rgba(59, 130, 246, 0.08)',
        'glow-purple': '0 0 25px -5px rgba(59, 130, 246, 0.45), 0 0 10px -2px rgba(59, 130, 246, 0.3)',
        ...
        'glow-magenta': '0 0 25px -5px rgba(37, 99, 235, 0.45), 0 0 10px -2px rgba(6, 182, 212, 0.3)',
